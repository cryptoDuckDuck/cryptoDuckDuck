# [![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=F7F7F7&width=435&lines=Welcome+to+my+GitHub+profile)](https://git.io/typing-svg)

**Python Backend / Machine Learning & Data Science**

- Documenting and Studying Backend, ML/DS
- Building real projects, clean code, and full documentation
